//
// Created by okcoinlmh on 2021/4/7.
//
...
public:
    ...
    /*
     2. key_seed = 32位小写MD5(token)  1c85b0cc77a09ec1bfb36464e0990c31 = MD5("eyJhbGciOiJIUzUxMiJ9..r4CNlBNRNsrviwe7-_KnM8bx4HfaYUXENHNeP9c703hI3TTN6R5ynFhM5SLRQEBlL6srr-7doUpFL4cHsvBbRw")
     3. index = timstamp / 600 mod 32 (每10分钟产生新的index）, step = timestamp / 3600 mod 32 (每小时产生新的步长)
     4. key = "", for i = 0 ~ 32,  key.append(key_seed[(index + (step + i) *i) mod 32])
     5. sig = base64(AES256("key_seed&timestamp（秒)", key))
     */
    char *EncryptCBC(const char* token, unsigned int &outLen);
